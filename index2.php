  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="paginas/nosotros.php">NOSOTROS</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="paginas/catalogo2.php">CATALOGO</a>
        </li>
        <li class="nav-item">
          <a class="nav-link  active" href="paginas/login.php">LOGIN</a>
        </li>
      </ul>
...
<div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    <div class="card h-100">
      <img src="img/i10.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Alicate de carbono</h5>
  ...
  <div class="col">
    <div class="card h-100">
      <img src="img/i9.png" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Lave Inglesa</h5>
        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
        <a href="#" class="btn btn-primary">$ 200</a>
      </div>
    </div>
...
<footer class="bg-light text-center text-lg-start">
  ...
  <div class="text-center p-3" style="background-color: rgba(124, 153, 149);">
    © 2020 Copyright:
    <a class="text-dark" href="#">Ferreteria Pernomania</a>
  </div>
