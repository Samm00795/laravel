...
<header>
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img id="logo" src="../img/1.png"  class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">       
        <h1 id="nombre" class="card-text"> Ferreteria   pernomania 'detalle'</h1>       
      </div>
    </div>
  </div>
</div>
...
<div id="carouselImages" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <img id="dlogo" src="<?php echo $rutaimg; ?>" class="d-block w-100">
    </div>
  </div>
